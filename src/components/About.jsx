    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="relative flex justify-center mb-16">
          <div className="absolute inset-0 bg-gradient-to-r from-red-900 via-red-600 to-red-900 rounded-full blur-lg opacity-20"></div>
          <img
            src="https://media.licdn.com/dms/image/v2/D4E03AQG53voO84DOBg/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1729091132977?e=1753315200&v=beta&t=r8H85GxrC5m-IUMNQvZeRSsFK04wxXf-vWfNkE0ffic"
            alt="Profile"
        ...
        <div className="text-center space-y-8 mb-16">
          <h1 className="text-6xl font-bold bg-gradient-to-r from-red-800 via-red-600 to-red-800 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-2xl text-red-900 font-semibold mb-4">
              Backend Development
            </h3>
            <p className="text-lg text-gray-600">
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-2xl text-red-400 font-semibold mb-4">
              UI/UX Design
            </h3>
            <p className="text-lg text-gray-600">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left max-w-4xl mx-auto">
            ...
            <div className="space-y-3">
              <h3 className="text-2xl text-red-900 font-semibold">
                Tech Community
              </h3>
              <p className="text-lg text-gray-600">
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-red-800 via-red-600 to-red-800 p-12 rounded-xl text-white text-center">
          ...
          <a
            href="#contact"
            className="inline-block bg-white text-red-600 px-8 py-3 rounded-lg font-semibold text-lg hover:bg-opacity-90 transition-colors duration-200"
          >
            Get in Touch
          </a>
        </div>
